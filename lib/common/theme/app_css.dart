...
//Text Style dmPoppins extra bold
  ...
  TextStyle dmPoppinsSemiBold8= dmPoppins(fontWeight: semiBold,fontsize:FontSizes.f8);
  ...
  TextStyle dmPoppinsRegular8 = dmPoppins(fontWeight: regular,fontsize:FontSizes.f8);
  TextStyle dmPoppinsRegular6 = dmPoppins(fontWeight: regular,fontsize:FontSizes.f6);
